...
def calculate_average_speed(workspace_path, sync_time):
    try:
        ...
        sizes_output = subprocess.check_output(
            p4_sizes_command, shell=True, stderr=subprocess.STDOUT).decode("utf-8")
        ...
        average_speed = total_size_bytes / (sync_time * 1024 * 1024)
...
if __name__ == "__main__":
    workspace_path = r"vtyagi_pun-wks-ad018_main_code"
